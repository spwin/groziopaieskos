...
@section('content')
    ...
    <div class="form-group">
        {!! Form::label('imones_kodas', 'Įmonės kodas', ['class' => 'control-label']) !!}
        {!! Form::text('imones_kodas', $organization->getOrganizationData()->first()->imones_kodas, ['required' => 'required', 'class' => 'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label('pvm_kodas', 'PVM kodas', ['class' => 'control-label']) !!}
        {!! Form::text('pvm_kodas', $organization->getOrganizationData()->first()->pvm_kodas, ['required' => 'required', 'class' => 'form-control']) !!}
    </div>
    <div class="form-group">
